...
-- Server helper: Waypoint/Marker coords abfragen (für Logging)
-- Rückgabe: vector3 coords oder nil, wenn kein Waypoint gesetzt ist.
lib.callback.register('qbx_core:client:getWaypointCoords', function()
    local blipMarker <const> = GetFirstBlipInfoId(8)
    if not DoesBlipExist(blipMarker) then return nil end
